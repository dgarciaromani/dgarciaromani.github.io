...
import { Container, Box, Divider, CardContent, Typography, Tab, Tabs } from '@mui/material';
    ...
    return (
        <Box>
            <Container>
                <h1>Contact me!</h1>
                <Divider />
                <p>Let's connect! Whether you have a project in mind, want to discuss a potential partnership, or just want to chat, I'd love to hear from you. Don't hesitate to drop me a message through my social media links. Looking forward to hearing from you!</p>
            </Container>
                    ...
                    <Box>
                        <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', paddingBottom: '0' }}>
                            <a key={index} href={item.link} target="_blank" rel="noopener noreferrer">
                                <img src={item.srcWhite} alt={item.name} width="150px" onMouseEnter={(e) => { e.target.src = item.srcGreen; }} onMouseLeave={(e) => { e.target.src = item.srcWhite; }}/>
                            </a>
                            <Typography variant="h5" component="div" sx={{  color: 'text.primary', fontWeight: 'bold', textAlign: 'center' }}>
                                {item.name}
                            </Typography>
                        </CardContent>
                    </Box>
            ...
            <Container>
                <Box sx={{ width: '100%' }}>
                    ...
                    <TabPanel value={value} index={0}>
                        <p>I currently live in Philadelphia, a vibrant city with its own unique charm. However, I am open to the possibility of relocating in the future. I am always open to considering new opportunities that may come my way.</p>
                    ...
                    <p>I was born in Chile, a captivating country known for its breathtaking landscapes and esteemed wine culture. Santiago was my home for many years, and I always enjoy going back from time to time.</p>
                        <Container sx={{ display: 'flex', justifyContent: 'center'}}>
